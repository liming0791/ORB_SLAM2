...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mvuRight(F.mvuRight), mvDepth(F.mvDepth), mDescriptors(F.mDescriptors.clone()),img(F.img.clone()),Thumbnail(F.Thumbnail.clone()),
...
{
    // We assume the mparent_KfId_map list has been initialized and contains the Map point IDS
    // With nid, Search the KetFrame List and populate mvpMapPoints
    long unsigned int id;
    bool is_valid = false;
    bool kf_found = false;
